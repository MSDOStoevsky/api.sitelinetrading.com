...
dotenv.config();
const MONGO_CONNECTION_URL = `mongodb://${process.env.MONGO_USER}:${process.env.MONGO_PWD}@${process.env.MONGO_IP}:27017/siteline?directConnection=true&serverSelectionTimeoutMS=2000`;
